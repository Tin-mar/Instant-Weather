...
// Modifier la fonction handleMeteoSearch existante pour inclure l'historique
const originalHandleMeteoSearch = handleMeteoSearch;
    ...
    if (selectedCommune && selectedDays) {
        try {
            ...
            if (meteoData.length) {
                ...
                // Ajouter à l'historique après succès
...
document.addEventListener('DOMContentLoaded', function () {
    // Attendre un peu pour s'assurer que tout le reste est initialisé
    setTimeout(() => {
